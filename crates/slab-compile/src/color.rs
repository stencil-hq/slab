...
fn oklab_to_rgb(l: f64, a: f64, b: f64) -> [u8; 3] {
	let l_ = 0.215_803_757_3f64
		.mul_add(b, 0.396_337_777_4f64.mul_add(a, l))
		.powi(3);
	let m_ = 0.063_854_172_8f64
		.mul_add(-b, 0.105_561_345_8f64.mul_add(-a, l))
		.powi(3);
	let s_ = 1.291_485_548_0f64
		.mul_add(-b, 0.089_484_177_5f64.mul_add(-a, l))
		.powi(3);
