...
use slab_compile::react::generate;
use slab_compile::wc::{WcFile, WcOptions};
...
pub fn cmd_gen_react(args: &[String]) -> ExitCode {
    ...
    eprintln!(
        "wrote {} + {stem}.js + .d.ts + slab-runtime.js + wasm/slab_kernel_bg.wasm \
         (single Rust/WASM runtime; {n_elems} element{})",
